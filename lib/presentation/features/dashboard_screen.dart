...
// افترضي اسم الـ Cubit الخاص بالإشعارات هنا إذا كان منفصلاً، أو استبدليه بالـ Cubit المناسب عندك
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    // لو عندك ميثود لتحديث الإشعارات عند فتح الشاشة استدعيها هنا:
    // context.read<NotificationCubit>().getUnreadNotificationsCount();
  }
    ...
    return Scaffold(
                ...
                children: [
                      ...
                      if (state is DashboardLoadingState) {
                        ...
                        return LayoutBuilder(
                          builder: (context, constraints) {
                            double aspectRatio =
                                constraints.maxWidth < 360 ? 1.1 : 1.2;
                              ...
                              children: [
                                itemCard(
                                  ...
                                  dashboardData?.todayStatus?.status ??
                                      "Absent",
                                  dashboardData?.todayStatus?.checkIn ??
                                      "Not Checked In",
                                  ColorsApp.blueColor,
                                  Image.asset(
                                ...
                                itemCard(
                                  ...
                                  Image.asset(
                                    "assets/images/umberella.png",
                                    fit: BoxFit.contain,
                                  ),
                                ),
                                itemCard(
                                  "Active Tasks",
                                  dashboardData?.activeTasks?.count
                                          ?.toString()
                                          .padLeft(2, '0') ??
                                      "00",
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: ColorsApp.greyColor.withOpacity(0.1),
                      ),
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            builder: (context, state) {
                              ...
                              return BarChart(
                                BarChartData(
                                  ...
                                  barTouchData: BarTouchData(
                                    ...
                                    touchTooltipData: BarTouchTooltipData(
                                      ...
                                      tooltipBorder: BorderSide(
                                        color: ColorsApp.greyColor.withOpacity(
                                          0.3,
                                        ),
                                      ),
                                      getTooltipItem: (
                                  ...
                                  barGroups: List.generate(chartList.length, (
                                    index,
                                  ) {
                                    final item = chartList[index];
                                    double onTime =
                                        (item.onTimeCount ?? 0).toDouble();
                                    double late =
                                        (item.lateCount ?? 0).toDouble();
                      ...
                      children: [
                        ...
                        BlocBuilder<DashboardCubit, DashboardStates>(
                          ...
                          builder: (context, state) {
                            ...
                            final projectsList =
                                context.read<DashboardCubit>().myProjectsList;
                            ...
                            return SingleChildScrollView(
                              ...
                              child: Row(
                                children: List.generate(projectsList.length, (
                                  index,
                                ) {
                                  ...
                                  double progressValue =
                                      (project.projectProgress ?? 0) / 100.0;
                                  return Padding(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: SizedBox(
          width: double.infinity,
          height: double.infinity,
          child: Image.asset('assets/images/staffly.png', fit: BoxFit.cover),
        ),
      ),
    );
  }
