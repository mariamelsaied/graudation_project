              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    _buildMenuItem(context, Icons.calendar_today_outlined, "My Attendance", currentPage == "Attendance", routeName: '/attendance'),
                    _buildMenuItem(context, Icons.assignment_outlined, "My Requests", currentPage == "My Requests", routeName: '/request'),
                    _buildMenuItem(context, Icons.drafts, "My Leaves", currentPage == "Leaves", routeName: '/leaves'),
