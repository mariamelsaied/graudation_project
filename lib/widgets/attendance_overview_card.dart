        ...
        children: [
          Row(
            children: [
              ...
              const _LegendDot(label: 'On-time', color: Color(0xff00b2ff)),
              const SizedBox(width: 12),
              _LegendDot(label: 'Hours', color: ColorsApp.greenColor),
            ],
          ),
          ...
          FutureBuilder<List<AttendanceDayData>>(
            ...
            builder: (context, snapshot) {
              ...
              return _AttendanceChart(data: snapshot.data!);
            },
          ),
        ],
      ),
